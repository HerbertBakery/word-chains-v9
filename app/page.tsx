...
export default function Page() {
  return (
    <main className="min-h-[calc(100dvh-4rem)] bg-gradient-to-br from-amber-50 to-sky-50 dark:from-zinc-900 dark:to-slate-900">
  ...
  <li><b>Records:</b> Lifetime stats: Highest Score, Longest Chain, Highest Multiplier, Best Single-Word,
      Longest Word, and category streaks.</li>
