    ...
    const usePower = (key: PowerKey) => {
      setPowerCharges((ch) => {
        ...
        if (key === "country") {
          ...
          // Determine target category from the *latest* chain membership (prevCats)
          ...
          (async () => {
            ...
            if (picked) {
              ...
              // Nothing found: still consumed (as requested)
          ...
          // NEW: Montage → FULL FREEZE until next valid word
          setPaused(true);
